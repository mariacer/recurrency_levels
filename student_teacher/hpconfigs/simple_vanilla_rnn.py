...
search_space = {
    'lr': hp.choice('lr', [1e-3, 1e-2, 1e-1]),
    'n_iter': hp.choice('n_iter', [10, 50, 100, 1000, 5000]),
    'rnn_arch': hp.choice('rnn_arch', ["32", "64", "128", "1024"]),
    'orthogonal_hh_init': hp.choice('orthogonal_hh_init', [True, False]),
    'rec_sparsity': hp.choice('rec_sparsity', [0.2, 0.4, 0.6, 0.8]),
}
