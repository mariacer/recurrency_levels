...
#
# @title           :student_teacher/hpconfigs/multiple_students.py
# @author          :am
...
_MODULE_NAME = 'student_teacher.run_multiple_student_teacher'
...
search_space_config = {
    'lr': [1e-4, 1e-3, 1e-2],
    'n_iter': [10, 20, 100, 1000, 2000],
    'teacher_rnn_arch': [6, 8, 10, 12],
    'teacher_rec_sparsity': [0.05, 0.1, 0.2, 0.5, 0.7],
    'teacher_output_size': [10, 50, 100], 
    'teacher_input_size': [10, 50, 100], 
    'teacher_n_ts_in': [50, 100, 500], 
    'teacher_n_ts_out': [50, 100, 500]
    }
...
_SUMMARY_KEYWORDS = [
    ...
    'num_neurons_teacher',
    'rnn_arch_teacher',
    'rec_sparsity_teacher',
    'feedforwardness_std',
    'cycles_adjacency_std',
    'ratio_cycles_std',
    'cycles_recursive_corr_std',
    'cycles_adjacency_corr_std',
    # 'corr_cycles_adjacency',
    # 'corr_cycles_recursive',
    # 'corr_ratio_cycles',
    # 'corr_cycles_adjacency_corr',
    # 'corr_cycles_recursive_corr',
    'corr_feedforwardness',
]
...
_PERFORMANCE_KEY = 'corr_feedforwardness'
