...
# python_version  :3.7
"""
Part-of-Speech tagging experiments with a microcircuit
------------------------------------------------------
"""
...
def run():
    ...
    ### Setup.
    config = parse_cmd_arguments(experiment='pos_tagging_microcircuit')
    device, writer, logger = sutils.setup_environment(config,
        script_name=globals()['__file__'])   
    logger.info('Running PoS tagging experiment with a microcircuit.')
