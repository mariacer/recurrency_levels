...
#
# @title           :real_world_benchmarks/hpconfigs/pos_rnn.py
# @author          :am
...
_MODULE_NAME = 'real_world_benchmarks.run_pos'
...
search_space = {
    ...
    'n_iter': hp.choice('n_iter', [1e-4, 1e-3, 1e-2]),
    'weight_decay': hp.loguniform('weight_decay', np.log(1e-8), np.log(1e-3)),
    'rnn_arch': hp.choice('rnn_arch', ["5"]),  #32", "64", "128"]),
