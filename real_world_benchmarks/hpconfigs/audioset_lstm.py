...
#
# @title           :real_world_benchmarks/hpconfigs/hpsearch_config.py
# @author          :am
...
search_space = {
    ...
    'weight_decay': hp.loguniform('weight_decay', np.log(1e-8), np.log(1e-2)),
    'rnn_arch': hp.quniform('rnn_arch', 32, 1024, 1),
    'n_iter': hp.quniform('n_iter', 10000, 60000, 1),
    'rnn_post_fc_layers': hp.choice('rnn_post_fc_layers', ["", "32"]),
