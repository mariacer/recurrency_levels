...
Data were preprocessed by an external script and then uploaded to
...
be preprocessed from scratch (contact behret@ethz.ch).

The implementation is based on an implementation by Benjamin Ehret in
another project:
...
class AudiosetData(SequentialDataset):
    ...
    def __init__(self, data_path, use_one_hot=True, validation_size=0,
        ...
        data_path = os.path.join(data_path,
            'audioset/audioset_data_balanced.pickle')
